export const Constants = {
  ...
  openChallengesShouldHaveLowerLimit:
    "Open Challenges must have lower cut off limit",
  openChallengesWrongOptions:
    "Wrong Options have been provided to open challenge",
  fixedChallengesShouldHaveUpperLimitAndFixedLimit:
    "Fixed Challenges should have upper limit and a fixed limit",
  fixedChallengesWrongOptions:
    "Wrong Options have been provided to fixed challenge",
  ...
  multipleCategoriesShouldBeProvided:
    "More than one categories should be provided",
  knockoutTypeShouldBeProvided: "Knockout type should be provided",
  hourlyKnockoutChallengesMustHaveCutOffHours:
    "Hourly Knockout Challenges must have Cut Off Hours",
  dailyKnockoutChallengesMustHaveCutOffDays:
    "Daily Knockout Challenges must have Cut Off Days",
  challengeNotFound: "Challenge not found",
  selectedCategoryDoesNotExitsInChallenge: (categoryId: string) =>
    `Selected category ${categoryId} does not exist in challenge`,
  ...
  // products
  productAddedToCategorySuccessfully:
    "Product has been added to category successfully",
  ...
  challengeAddedToCartSuccessfully:
    "Challenge has been added to cart successfully",
  challengeRemovedFromCartSuccessfully:
    "Challenge has been removed from cart successfully",
  ...
  // shipping details
  shippingDetailsAddedSuccessfully:
    "Shipping details has been added successfully",

  // order summary
  orderDetailsFetchedSuccessfully:
    "Order Details have been fetched successfully",
  ...
  productDeletedFromInventorySuccessfully:
    "Product has been deleted from inventory",
  ...
  pleaseAddEmptyFields: (emptyFields: string) =>
    `Please add ${emptyFields} field(s)`,
  pleaseAddName: "Please add a name",
  pleaseAddEmail: "Please add an email",
  authorizationError: "You are not authorized",
  forbiddenParameters: (forbiddenParams: string) =>
    `Forbidden parameter(s): ${forbiddenParams}`,
  requiredParameters: (requiredParams: string) =>
    `Missing required parameter(s): ${requiredParams}`,
  notificationEmailSubject: (tournamentName: string, teamName: string) =>
    `Registration for ${tournamentName} - ${teamName}`,
  notificationEmailBody: (
    tournamentName: string,
    teamName: string,
    fromName: string
  ) =>
    `<p>Hello,</p><p>Your team "${teamName}" has been registered for the "${tournamentName}" tournament by "${fromName}"</p><p>Thank you!</p>`,
