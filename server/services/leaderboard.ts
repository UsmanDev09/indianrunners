...
export const addUserToLeaderboard = (challenge: ChallengeInterface, category: ChallengeCategoryInterface, user: UserInterface) => LeaderboardModel.updateOne({ challenge: challenge._id, category: category._id }, {$push: { userDetails: {user: user._id, rank: 0, pace: 0, distance:0, qualifiedDays: 0, qualifiedHours: 0 } } })
...
export const updateRankingInLeaderboard = (leaderboard: Leaderboard) => {
    leaderboard.userDetails.sort((a, b) => (b.distance || 0) - (a.distance || 0));
