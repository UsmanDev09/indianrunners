...
export const updateUserChallengeByUserId = (user: UserInterface, challenge: ChallengeInterface) => UserChallenges.updateOne({ _id: user._id }, { $push: { 'challenges': challenge }}  )
