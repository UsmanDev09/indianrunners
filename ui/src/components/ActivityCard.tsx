  ...
  return (
    <div className="flex flex-wrap mt-12 gap-2 justify-center">
      {activities && activities.map(
        (activity: any, index) =>
          activity && (
            <div key={index} className="max-w-sm p-6 bg-white dark:bg-violet border border-gray-200 rounded-lg dark:text-white shadow dark:bg-gray-800 dark:border-gray-700 m-5">
              <a href="#">
