...
const DeleteChallenge = ( {setChallenges, challenge, setOpenDeleteProductDrawer, openDeleteProductDrawer } : { setChallenges: (products: Challenge[]) => void, challenge: Challenge, setOpenDeleteProductDrawer : (action: boolean) => void, openDeleteProductDrawer: boolean }) => {
    const [ formData, setFormData ] = useState({id: challenge._id})
