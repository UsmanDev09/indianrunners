...
const Challenges = ({ initialChallenges, categories } : { initialChallenges: Challenge[], categories: ChallengeCategory[] } ) => {
    const [openCreateChallengeDrawer, setOpenCreateChallengeDrawer] = useState<boolean>(false)
    ...
    return (
        <div className='w-full container'>
            <CreateChallenge setChallenges={setChallenges} categories={categories} setOpenCreateChallengeDrawer={setOpenCreateChallengeDrawer} openCreateChallengeDrawer={openCreateChallengeDrawer} />
            {challengeToDelete && <DeleteChallenge setChallenges={setChallenges} challenge={challengeToDelete} setOpenDeleteProductDrawer={setOpenDeleteProductDrawer} openDeleteProductDrawer={openDeleteProductDrawer} /> }
            <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-dark-green dark:border-gray-700">
                <div className="mb-1">
                    ...
                    <div className="items-center justify-between block sm:flex md:divide-x md:divide-gray-300 dark:divide-gray-700">
                        ...
                        <button className='text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-700 dark:hover:bg-gray-700 dark:focus:ring-blue-800' onClick={() => setOpenCreateChallengeDrawer(!openCreateChallengeDrawer)}>
                            Add New Challenge
                        </button>
                    </div>
                </div>
                                        ...
                                        <tbody key={index} className="bg-white divide-y divide-gray-300 dark:bg-dark-green dark:divide-gray-700">
                                            <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    <Image src={challenge.image!} width={50} height={50} alt='challenge image' />
                                                </td>
                                                <td className="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                    <div className="text-base font-semibold text-gray-900 dark:text-white">{challenge.name}</div>
                                                </td>
                                                <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{challenge.activity}</td>
                                                <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{challenge.price}</td>
                                                <td className="p-4 space-x-2 whitespace-nowrap">
                                                    <button onClick={() => {setOpenDeleteProductDrawer(!openDeleteProductDrawer), setChallengeToDelete(challenge)} } type="button" id="deleteChallengeButton" data-drawer-target="drawer-delete-product-default" data-drawer-show="drawer-delete-product-default" aria-controls="drawer-delete-product-default" data-drawer-placement="right" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-gray-200 dark:text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                                                        <svg className="w-4 h-4 mr-2 text-gray-900 hover:text-gray-900 dark:text-gray-200" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                                        Delete Challenge
                                                    </button>
                                                </td>
                                            </tr>
