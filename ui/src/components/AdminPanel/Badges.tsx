...
import { ApiService, Badge, BadgeCriteria } from "../../pages/api";
import CreateBadge from "./CreateBadge";
//import DeleteBadge from "./DeleteBadge";

const Badges = ({ initialBadges }: { initialBadges: Badge[] }) => {
  const [openCreateBadgeDrawer, setOpenCreateBadgeDrawer] = useState<boolean>(
    false
  );
  const [openDeleteBadgeDrawer, setOpenDeleteBadgeDrawer] = useState<boolean>(
    false
  );
  const [badgeToDelete, setBadgesToDelete] = useState<Badge>();
  ...
  return (
    <div className="w-full container">
      <CreateBadge
        setBadges={setBadges}
        setOpenCreateBadgeDrawer={setOpenCreateBadgeDrawer}
        openCreateBadgeDrawer={openCreateBadgeDrawer}
      />
      {/* {BadgeToDelete && (
        <DeleteBadge
          setBadges={setBadges}
          badge={BadgeToDelete}
          setOpenDeleteBadgeDrawer={setOpenDeleteBadgeDrawer}
          openDeleteBadgeDrawer={openDeleteBadgeDrawer}
        />
      )} */}
          ...
          <div className="items-center justify-between block sm:flex md:divide-x md:divide-gray-300 dark:divide-gray-700">
            <div className="flex items-center mb-4 sm:mb-0">
              <form className="sm:pr-3" action="#" method="GET">
                <label htmlFor="Badges-search" className="sr-only">
                  Search
                </label>
                    ...
                    return (
                      ...
                      >
                        <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {Badge.criteria?.numberOfActivities}
                          </td>

                          <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {Badge.criteria?.distance}
                          </td>
                          <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          ...
                          <td className="p-4 space-x-2 whitespace-nowrap">
                            <button
                              onClick={() => {
                                setOpenDeleteBadgeDrawer(
                                  !openDeleteBadgeDrawer
                                ),
                                  setBadgesToDelete(Badge);
                              }}
                              type="button"
                              id="deleteBadgeButton"
                              data-drawer-target="drawer-delete-Badge-default"
                              data-drawer-show="drawer-delete-Badge-default"
                              aria-controls="drawer-delete-Badge-default"
