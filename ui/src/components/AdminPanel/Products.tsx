                                    ...
                                    return (
                                        <tbody key={index} className="bg-white divide-y divide-gray-300 dark:bg-dark-green dark:divide-gray-700">
                                            <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{product.description}</td>
                                                <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{product.price}</td>
                                                <td className="p-4 space-x-2 whitespace-nowrap">
                                                    <button onClick={() => {setOpenUpdateProductDrawer(!openUpdateProductDrawer), setProductToUpdate(product)} } type="button"  className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-gray-200 dark:text-white rounded-lg bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-primary-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
