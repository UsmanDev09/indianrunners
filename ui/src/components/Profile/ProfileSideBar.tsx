            ...
            {profileArray.map((ele, index) => {
              ...
              return (
                <li key={index} className="mt-2">
                  <Link
                    href={ele.path}
                    className="flex items-center p-2 xs:bg-gray-100 xs:ml-2 xl:ml-0 dark:bg-dark-button dark:hover:bg-gray text-base font-norma text-dark-gray-800 dark:text-gray-300 rounded-lg hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-gray-700 dark:focus:bg-gray-700 "
                  >
