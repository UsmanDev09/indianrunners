...
const ItemCard = ({ title, price, picture, type, _id }: ItemCard_Props) => {
  ...
  return (
    <div className="w-[300px] sm:w-[360px] h-[338px] max-w-sm bg-white dark:bg-dark-card shadow-xl rounded-lg dark:border-gray-700">
      <Link href="#">
        <Image
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
          ...
          <svg
            className="w-4 h-4 text-gray dark:text-gray-600"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 22 20"
          ...
          <span
            className={` ${josef.className} bg-blue-100 text-blue-800 text-sm font-semibold mr-2 px-2.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3`}
          >
            5.0
          </span>
        </div>
