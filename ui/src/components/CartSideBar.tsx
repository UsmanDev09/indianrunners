            ...
            <div className="fixed inset-0 overflow-hidden ">
                ...
                <div className="fixed inset-y-0 right-0 flex max-w-full pl-10 ">
                    ...
                    <div className={`flex h-full flex-col overflow-y-scroll bg-white shadow-xl`}>
                        <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6 dark:bg-dark dark:text-white">
                            <div className="flex items-start justify-between">
                                <h2 className="text-lg font-medium text-gray-900 dark:text-white" id="slide-over-title ">Shopping cart</h2>
                                <div className="ml-3 flex h-7 items-center dark:text-white">
                                <button onClick={(e) => { e.stopPropagation(), setShowCartSidebar(false)}} type="button" className="relative -m-2 p-2 text-gray-400 hover:text-gray-500 dark:text-white ">
                            ...
                            <div className="mt-8 ">
                                ...
                                <ul role="list" className="-my-6 divide-y divide-gray-200 dark:text-white">
                                    {cart && cart.map((cartDetails, index) => {
                                        return cartDetails.itemType === 'challenge' ? (
                                            <li key={index} className="flex py-6">
                                                ...
                                                <div className="ml-4 flex flex-1 flex-col ">
                                                    <div>
                                                        ...
                                                        {cartDetails.itemDetails && (<p className="text-left mt-1 text-sm text-gray-500 dark:text-white">{cartDetails.itemDetails[0].challengeCategories && cartDetails.itemDetails[0].challengeCategories.length > 0 ? cartDetails.itemDetails[0].challengeCategories[0].name : ''}</p>)}
                                                    </div>
                                                    <div className="flex flex-1 justify-between text-sm">
                                                        <p className="text-gray-500 "></p>

                                                        <div className="flex">
                                                            <button onClick={() => {if(cartDetails.itemDetails) removeChallengeFromCart(cartDetails.itemDetails[0]?.challenge!, cartDetails._id)} } className={`text-xl font-medium ${loading && 'text-indigo-300'} text-indigo-600 hover:text-indigo-500 dark:text-white`}>Remove</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <li key={index} className="flex py-6 ">
                                                <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200 dark:text-white">
                                                <Image
                                                ...
                                                <div className="ml-4 flex flex-1 flex-col ">
                                                    ...
                                                    <div className="flex flex-1 justify-between text-xl ">
                                                        ...
                                                        <div className=" ">
                                                            ...
                                                            <button disabled={loading} onClick={() => {if(cartDetails.itemDetails) removeProductFromCart(cartDetails.itemDetails[0]?.product! && cartDetails.itemDetails[0]?.product._id!, cartDetails._id)} } className={`font-medium ${loading && 'text-indigo-300'}  text-indigo-600 hover:text-indigo-500 dark:text-white`}>Remove</button>
                                                        </div>
                                                    </div>
                                                    </div>
                                                </div>
                        ...
                        <div className="border-t border-gray-200 px-4 py-6 sm:px-6 dark:bg-dark 
                        ">
                        ...
                        <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                            <p>
                            or
                            <button type="button" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-white">
                                Continue Shopping
