            ...
            <nav className="bg-violet">
              ...
              <div className={`flex bg-white text-black ${josef.className} pt-2.5`}>
                <div className="container mx-auto  flex justify-between w-full">
                  ...
                  <div className="sm:flex flex-row py-3 items-center justify-end hidden">

                  </div>

                {/* Notifications */}

                  <button ref={iconRef} onClick={onClickNotifications} className="flex items-center">
                  ...
                  {createPortal(
                  <div ref={dropdownRef} className={`${showNotifications ? 'block' : 'hidden'} flex justify-center absolute right-16 top-24 transition transform`}>  
                  <div id="dropdownNotification" className="w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700" aria-labelledby="dropdownNotificationButton">
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-gray-700">
                      {notifications && notifications.length > 0 ? notifications.map((notification: any, index: number) => {
                        return (<a key={index} href="#" className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                          <div className="flex-shrink-0">
                            <Image className="rounded-full w-11 h-11" src="/default-profile-image.png" alt="Jese image" width={8} height={8} />
                      ...
                      }) : <p className='m-2'> You do not have any notifications. </p>}
                    </div>
