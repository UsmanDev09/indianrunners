...
export default function Payment() {
    ...
    <body>
        <form method="post" name="customerData" action="http://localhost:5000/api/payment">
            <table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
                <table width="50%" height="100" border='1' align="center">
                    ...
                    <tr>
                        <td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="210148"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://indianrunners.in/ccavResponseHandler.asp"/></td>
                    </tr>
                     <tr>
                         <td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://localhost:3001/ccavResponseHandler.asp"/></td>
                     </tr>
                     <tr>
                    ...
                    <tr>
                        <td>Billing Tel	:</td><td><input type="text" name="billing_tel" value="9896226054"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Shipping Tel	:</td><td><input type="text" name="delivery_tel" value="9896226054"/></td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
      $(function(){
         ...
         */	  
            var jsonData;
            var access_code = "AVKE83GB75CH25EKHC" // shared by CCAVENUE 
            var amount="10.00";
            var currency="INR";
...
return(
    <HtmlEmbed htmlContent={htmlContent}/>
)
